  ...
  <section>
    ...
    <div class="card" style="width: 70rem; height: 50rem; margin-right:auto; margin-left:auto;">
      ...
      if(isset($_REQUEST['clothes2'])){
        ...
        $requete=$mysqli->query("SELECT * FROM vetements WHERE Photo1 LIKE 'clothes2.jpeg' ");
        $ligne=$requete->fetch();
      }
      if(isset($_REQUEST['clothes3'])){
        ...
        $requete=$mysqli->query("SELECT * FROM vetements WHERE Photo1 LIKE 'clothes3.jpg' ");
        $ligne=$requete->fetch();
      }
      if(isset($_REQUEST['clothes4'])){
        ...
        $requete=$mysqli->query("SELECT * FROM vetements WHERE Photo1 LIKE 'clothes4.jpg' ");
        $ligne=$requete->fetch();
      }
      if(isset($_REQUEST['clothes5'])){
        ...
        $requete=$mysqli->query("SELECT * FROM vetements WHERE Photo1 LIKE 'clothes5.jpeg' ");
        $ligne=$requete->fetch();
      }
      if(isset($_REQUEST['clothes6'])){
        ...
        $requete=$mysqli->query("SELECT * FROM vetements WHERE Photo1 LIKE 'clothes6.jpeg' ");
        $ligne=$requete->fetch();
